...
export const SHARE_MESSAGE = `Hello all, I am very excited to share that I have successfully completed the Fullstack Live 0-1 Cohort and learned things from Kirat !! #certification #100xDevs 🎓 🏆 `
